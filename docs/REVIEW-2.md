...
**Stage 8. Docs and names (Forge, hand for the rename). Done 2026-09-18 for the docs: two tasks, $3.65; README's layout with a test that names every module, SYSTEM.md regenerated. The unit (`forge-worker`) and the bare remote (`forge.git`) were renamed by hand on 2026-09-19 at the first quiet queue.** WORKFLOWS.md's
