...
**Stage 5. Jobs made visible (Forge, after 2).** `JobStarted`/
...
**Stage 7. Rows once (Forge, after 2).** The view mirrors for jobs,
...
**Stage 8. Docs and names (Forge, hand for the rename).** WORKFLOWS.md's
