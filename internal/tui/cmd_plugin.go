...
func RunPlugin(ctx context.Context, c *Context, args []string) int {
...
func pluginArg(c *Context, name string, fsArgs []string) (string, int) {
	if len(fsArgs) != 1 {
...
func runPluginList(ctx context.Context, c *Context, args []string) int {
...
func runPluginInstall(ctx context.Context, c *Context, args []string) int {
...
func finishPluginInstall(ctx context.Context, c *Context, log *slog.Logger, name, kind string) int {
	cl := c.Client(log)
	if err := cl.Connect(ctx); err != nil {
		return c.Fail("plugin install", err)
	}
...
func runPluginBuild(ctx context.Context, c *Context, dir string, build []string) error {
...
func runPluginUninstall(ctx context.Context, c *Context, args []string) int {
...
func runPluginEnable(ctx context.Context, c *Context, args []string) int {
...
func confirm(c *Context, prompt string) bool {
...
func runPluginDisable(ctx context.Context, c *Context, args []string) int {
...
func runPluginLogs(ctx context.Context, c *Context, args []string) int {
...
func runPluginStatus(ctx context.Context, c *Context, args []string) int {
...
func (c *Context) pluginDiscoveryRoots(ctx context.Context, log *slog.Logger) []string {
