...
func TestRegistry(t *testing.T) {
	...
	wantNames := []string{
		...
		"forge_repo_status", "forge_request_budget", "forge_retro_pack", "forge_scratch",
		"forge_script_run", "forge_stats", "forge_usage", "forge_work_outcomes", "forge_workflow_run",
	}
	all := reg.All()
